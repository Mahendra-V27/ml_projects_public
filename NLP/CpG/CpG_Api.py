...
# Example usage
# model_name = "CPG Prediction Model"
# input_string = "ACGTACGT"
# prediction = predict(input_string, model_name)
# print(f"Prediction for '{input_string}' using '{model_name}': {prediction}")
#
#
# model_name = "CPG Prediction Model Padded"
# input_string = "NCCGGCCNN"
# prediction = predict(input_string, model_name, )
# print(f"Prediction for '{input_string}' using '{model_name}': {prediction}")
#
#
# model_name = "CP Count Model Padding with Embedding"
# input_string = "NCCGGCCNN"
# prediction = predict(input_string, model_name, )
# print(f"Prediction for '{input_string}' using '{model_name}': {prediction}")


model_name = "CP Prediction Embedding Model"
input_string = "NNN"
prediction = predict(input_string, model_name, )
print(f"Prediction for '{input_string}' using '{model_name}': {prediction}")
